...
LUA_SHA1 = get_hash(os.path.join(CWD, 'playstv.lua'))
...
project = Project(
    title = 'playstv',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://www.archiveteam.org/images/9/9c/Plays-logo-horizontal-dark-300x83.png" height="50px"/>
    <h2>plays.tv <span class="links"><a href="https://plays.tv/">Website</a> &middot; <a href="http://tracker.archiveteam.org/playstv/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://%s/%s' % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix='playstv'),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
